...
const Alerts = ({ children }: any) => {
 ...
 const posthog = usePostHog();
   ...
   useEffect(() => {
    posthog.capture("alerts_page_viewed");
  }, [posthog]);
  ...
  const notesQuery = useQuery({
    ...
    throwOnError: (error) => {
      ...
      posthog.capture("alerts_load_failed", {
        error,
  ...
  return (
    <div className="flex flex-1 flex-col">
      <div className="@container/main flex flex-1 flex-col ">
        ...
        <div
          className="xs:grid-cols-2 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4"
        >
          <div className="w-full py-4  grid gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-3">
