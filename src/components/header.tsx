...
const Header = ({title, isAlertEnabled, showAlertBadge}: { title?: string, isAlertEnabled?: boolean, showAlertBadge?: boolean}) => {
                ...
                showAlertBadge && (
                  <>
                    <AnimatedTooltip 
                      className=""
                      trigger={[
                         <div className='group flex flex-row justify-center h-[36px] items-center gap-2 ' data-state={checked ? 'checked' : 'unchecked'}>
                      <span
                        id={`${id}-light`}
