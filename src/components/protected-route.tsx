import { Navigate, Outlet, useLocation } from "react-router-dom"; // Note: 'react-router' usually implies 'react-router-dom'
...
export const ProtectedRoute = () => {
  ...
  if (!userId) {
    return <Navigate  to={{ 
          pathname: "/", 
          search: location.search // Keeps things like "?promo=50off"
        }}  replace />;
  }
