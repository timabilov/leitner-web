...
import { cn } from "@/lib/utils"; // Assuming you have a standard cn utility. If not, remove this import and see note below.

const AIIcon = ({ className, ...props }) => {
  // Generate unique IDs for this specific instance of the icon
  const gradientId1 = useId();
  const gradientId2 = useId();

  return (
    <svg
      // Default to 16px (w-4 h-4) if no class is provided
