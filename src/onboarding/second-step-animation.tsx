    ...
    <div className="flex flex-col items-center justify-between w-full max-w-sm mx-auto h-full bg-white py-4 pt-0 font-sans tracking-tight">
        ...
        <AnimatePresence>
          {isRestored && (
            ...
            >
              ...
              <AIIcon size={14} className="text-blue-600" />
            </motion.div>
          )}
        </AnimatePresence>
      ...
      <div className="w-full text-center">
        <div className="flex flex-col gap-2.5 mb-8">
           <div onClick={() => window.open( "https://apps.apple.com/us/app/leitner-ai-note-quiz-alerts/id6747087851", "_blank")} className="flex items-center justify-center gap-2 text-slate-500 font-medium text-[13px] tracking-tight hover:cursor-pointer hover:underline">
             <Smartphone size={15} className="text-slate-900" />
